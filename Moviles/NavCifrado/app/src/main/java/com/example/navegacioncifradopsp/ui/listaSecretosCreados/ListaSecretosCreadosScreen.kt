...
@Composable
fun SecretosCreadosScreenViewModel(
    viewModel: ListaSecretosCreadosViewModel = hiltViewModel(),
    ...
    SecretosCreadosScreen()
}


@Composable
fun SecretosCreadosScreen(
...
@Composable
fun SecretosCreadosScreenPreview(){
        SecretosCreadosScreen()
}
